...
class IconMovieLogo extends React.Component{
    constructor(props) {
        super(props);
    }
    ...
    render (){
        return (
            <svg className={this.props.className} version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 66 59">
                <title>Logo</title>
